...
| Timing and precision | 100/200/400/1000 Hz gates; timestamped aiding delay matrix; float/double comparison at 400 Hz gives maximum deltas of `0.001124 deg`, `1.293 mm`, and `0.229 mm/s` | Closed for host evaluation; H7 WCET/stack remain open |
