...
- Strict host build, three C tests, and eleven Python tests pass on the recovered local machine.
...
three-axis IMU biases and monotonic timestamp jitter; thermal drift, transport delay, reordering,
dropout, and malformed streams remain separate fault-injection work.
